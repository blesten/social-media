  ...
  return (
    <>
      <div onClick={() => setOpenPostOverlay(true)} className='group w-64 h-64 bg-gray-200 rounded-lg cursor-pointer relative shadow-lg border border-gray-300'>
        <img src={post.images[0]} alt='Byte Craft Studio - Social Media' className='rounded-md w-full h-full object-cover border border-gray-200 pointer-events-none cursor-pointer' />
